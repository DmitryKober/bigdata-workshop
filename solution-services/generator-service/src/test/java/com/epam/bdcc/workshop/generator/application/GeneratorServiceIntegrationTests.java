...
public class GeneratorServiceIntegrationTests {
    ...
    private static final String KAFKA_RESOURCE_UTILIZATION_CONSUMER_GROUP = "generator-test-consumer-group";
    ...
    public void whenInvokingController_thenResourceConsumptionProvided() throws Exception {
        ...
        ResponseEntity<Void> responseEntity = restTemplate.postForEntity(
                "http://localhost:" + localServerPort + GeneratorController.CONTEXT + GeneratorController.SERVICE,
                request,
                Void.class
        );
        Thread.sleep(5000);
