...
public class VerificationServiceIntegrationTests {
    ...
    private static final String KAFKA_RESOURCE_UTILIZATION_CONSUMER_GROUP = "verification-test-consumer-group";
    ...
    public void whenInvokingController_thenResourceConsumptionProvided() throws Exception {
        ...
        ResponseEntity<Void> responseEntity = restTemplate.postForEntity(
                "http://localhost:" + localServerPort + VerificationController.CONTEXT + VerificationController.SERVICE,
                request,
                Void.class
        );
        Thread.sleep(5000);
